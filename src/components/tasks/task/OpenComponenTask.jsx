...
const OpenComponenTask = ({tasks})=> {
    ...
    return (
        <div className="overflow-y-auto overflow-x-hidden p-4 rounded-md">
          <p className="pl-2 w-full h-14 flex items-center bg-lime-400 mb-4 rounded-md text-lg text-black font-semibold">
            Open
          </p>
          <div className="flex flex-col gap-5 w-[300px] h-[200px]">
            {tasks.map((task) => (
              <div key={task.id} className="w-[300px] h-[200px] bg-lime-200 cursor-pointer" onClick={() => handleOpenModal(task)}>
                <div className="mt-4">
...
export default OpenComponenTask